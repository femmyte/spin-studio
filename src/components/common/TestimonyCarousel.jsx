...
function Item(props) {
	return (
		<div className='w-full mt-5 flex flex-col items-center justify-center h-full'>
			...
			<p className='text-[#9b9b9b] font-dmsans font-[400] text-[18.95px] leading-[24.6px] mb-[20px]'>
				{props.item.stack}
			</p>
